      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-10">
            ...
            <button
              onClick={() => openModal()}
              className="w-full p-6 border border-gold/20 bg-gold flex items-center justify-between group cursor-pointer hover:bg-black text-black hover:text-white transition-colors rounded-none"
            >
              <p className="text-sm font-black uppercase tracking-widest text-left">Ready to build your system?</p>
